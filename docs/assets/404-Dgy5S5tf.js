import { _ as v, g as r, e as a, o as d, d as f, b as l, w as t, i as o, ac as p, h as s } from './index-P4QeRV7n.js'
const m = {},
  g = { fill: 'none', height: '200', viewBox: '0 0 200 200', width: '200', xmlns: 'http://www.w3.org/2000/svg' }
function x(i, c) {
  return (
    d(),
    r(
...
const _ = v(m, [['render', x]]),
  h = { class: 'flex flex-col justify-between h-screen items-center bg-[var(--va-background-secondary)]' },
    ...
    setup(i) {
      return (c, e) => {
        ...
        return (
          d(),
          r('div', h, [
            l(u, { to: '/' }, { default: t(() => [l(p, { gradient: !1, class: 'my-8 h-5' })]), _: 1 }),
            a('div', w, [
              l(_),
              e[2] || (e[2] = a('h1', { class: 'va-h1 text-center sm:text-5xl text-4xl' }, 'Page not found', -1)),
              e[3] ||
                (e[3] = a(
                  'p',
                  { class: 'text-center' },
              ...
              a('div', b, [
                l(n, { to: '/' }, { default: t(() => e[0] || (e[0] = [s('Go to homepage')])), _: 1 }),
                l(
                  n,
                  {
                  ...
                  { default: t(() => e[1] || (e[1] = [s('Create a GitHub issue ')])), _: 1 },
                ),
              ]),
            ]),
...
export { M as default }
//# sourceMappingURL=404-Dgy5S5tf.js.map
