...
function W(n, e) {
  ...
  const t = v(),
    r =
      ...
      ((o = (c = e == null ? void 0 : e.locale) == null ? void 0 : c.options) == null ? void 0 : o.weekStartsOn) ??
      t.weekStartsOn ??
      ((h = (d = t.locale) == null ? void 0 : d.options) == null ? void 0 : h.weekStartsOn) ??
      0,
    a = l(n, e == null ? void 0 : e.in),
    i = a.getDay(),
    u = (i < r ? 7 : 0) + i - r
  return a.setDate(a.getDate() - u), a.setHours(0, 0, 0, 0), a
}
function D(n, e) {
  return W(n, { ...e, weekStartsOn: 1 })
}
function j(n, e) {
...
function I(n, e, t) {
  const [r, a] = R(t == null ? void 0 : t.in, n, e),
    i = H(r),
    u = H(a),
    c = +i - N(i),
    o = +u - N(u)
...
const U = {
  ...
  K = (n, e, t) => {
    ...
    const a = U[n]
    return (
      typeof a == 'string' ? (r = a) : e === 1 ? (r = a.one) : (r = a.other.replace('{{count}}', e.toString())),
...
const Z = { full: 'EEEE, MMMM do, y', long: 'MMMM do, y', medium: 'MMM d, y', short: 'MM/dd/yyyy' },
  p = { full: 'h:mm:ss a zzzz', long: 'h:mm:ss a z', medium: 'h:mm:ss a', short: 'h:mm a' },
  ee = {
    full: "{{date}} 'at' {{time}}",
    long: "{{date}} 'at' {{time}}",
    medium: '{{date}}, {{time}}',
  ...
  te = {
    date: Y({ formats: Z, defaultWidth: 'full' }),
    time: Y({ formats: p, defaultWidth: 'full' }),
    dateTime: Y({ formats: ee, defaultWidth: 'full' }),
  },
  ne = {
...
function k(n) {
  return (e, t) => {
    ...
    if (r === 'formatting' && n.formattingValues) {
      ...
      a = n.formattingValues[c] || n.formattingValues[u]
    } else {
      const u = n.defaultWidth,
        c = t != null && t.width ? String(t.width) : n.defaultWidth
      a = n.values[c] || n.values[u]
    }
    const i = n.argumentCallback ? n.argumentCallback(e) : e
    return a[i]
  }
}
const ae = { narrow: ['B', 'A'], abbreviated: ['BC', 'AD'], wide: ['Before Christ', 'Anno Domini'] },
  ie = {
    narrow: ['1', '2', '3', '4'],
  ...
  fe = {
    ordinalNumber: de,
    era: k({ values: ae, defaultWidth: 'wide' }),
    quarter: k({ values: ie, defaultWidth: 'wide', argumentCallback: (n) => n - 1 }),
    month: k({ values: ue, defaultWidth: 'wide' }),
    day: k({ values: se, defaultWidth: 'wide' }),
    dayPeriod: k({ values: ce, defaultWidth: 'wide', formattingValues: oe, defaultFormattingWidth: 'wide' }),
  }
function x(n) {
  return (e, t = {}) => {
    const r = t.width,
      a = (r && n.matchPatterns[r]) || n.matchPatterns[n.defaultMatchWidth],
      i = e.match(a)
    if (!i) return null
    const u = i[0],
      c = (r && n.parsePatterns[r]) || n.parsePatterns[n.defaultParseWidth],
      o = Array.isArray(c) ? me(c, (g) => g.test(u)) : he(c, (g) => g.test(u))
    let d
...
const ge = /^(\d+)(th|st|nd|rd)?/i,
  ...
  be = { any: [/^b/i, /^(a|c)/i] },
  Pe = { narrow: /^[1234]/i, abbreviated: /^q[1234]/i, wide: /^[1234](th|st|nd|rd)? quarter/i },
  Me = { any: [/1/i, /2/i, /3/i, /4/i] },
  Oe = {
    narrow: /^[jfmasond]/i,
  ...
  Se = {
    ordinalNumber: le({ matchPattern: ge, parsePattern: we, valueCallback: (n) => parseInt(n, 10) }),
    era: x({ matchPatterns: ye, defaultMatchWidth: 'wide', parsePatterns: be, defaultParseWidth: 'any' }),
    quarter: x({
      matchPatterns: Pe,
    ...
    month: x({ matchPatterns: Oe, defaultMatchWidth: 'wide', parsePatterns: ke, defaultParseWidth: 'any' }),
    day: x({ matchPatterns: xe, defaultMatchWidth: 'wide', parsePatterns: We, defaultParseWidth: 'any' }),
    dayPeriod: x({ matchPatterns: De, defaultMatchWidth: 'any', parsePatterns: ve, defaultParseWidth: 'any' }),
  },
  Ye = {
    code: 'en-US',
    formatDistance: K,
...
function G(n, e) {
  ...
  const t = l(n, e == null ? void 0 : e.in),
    ...
    i =
      ...
      ((g = (h = e == null ? void 0 : e.locale) == null ? void 0 : h.options) == null
        ? void 0
        : g.firstWeekContainsDate) ??
      a.firstWeekContainsDate ??
      ((O = (M = a.locale) == null ? void 0 : M.options) == null ? void 0 : O.firstWeekContainsDate) ??
      1,
    u = y((e == null ? void 0 : e.in) || n, 0)
  u.setFullYear(r + 1, 0, i), u.setHours(0, 0, 0, 0)
  const c = W(u, e),
    o = y((e == null ? void 0 : e.in) || n, 0)
...
function Ee(n, e) {
  ...
  const t = v(),
    r =
      (e == null ? void 0 : e.firstWeekContainsDate) ??
      ((o = (c = e == null ? void 0 : e.locale) == null ? void 0 : c.options) == null
        ? void 0
        : o.firstWeekContainsDate) ??
      t.firstWeekContainsDate ??
      ((h = (d = t.locale) == null ? void 0 : d.options) == null ? void 0 : h.firstWeekContainsDate) ??
      1,
    a = G(n, e),
    i = y((e == null ? void 0 : e.in) || n, 0)
...
const w = {
    ...
    S(n, e) {
      const t = e.length,
        r = n.getMilliseconds(),
        a = Math.trunc(r * Math.pow(10, t - 3))
      return s(a, e.length)
    },
  },
  P = {
...
function _(n, e) {
  return n % 60 === 0 ? (n > 0 ? '-' : '+') + s(Math.abs(n) / 60, 2) : b(n, e)
}
function b(n, e = '') {
  const t = n > 0 ? '-' : '+',
    r = Math.abs(n),
    a = s(Math.trunc(r / 60), 2),
    i = s(r % 60, 2)
  return t + a + e + i
}
const L = (n, e) => {
  ...
  qe = (n, e) => {
    ...
    return i.replace('{{date}}', L(r, e)).replace('{{time}}', B(a, e))
  },
  Ne = { p: B, P: qe },
  He = /^D+$/,
  Qe = /^Y+$/,
...
function $e(n, e, t) {
  var h, g, M, O, T, F, E, C
  const r = v(),
    a = (t == null ? void 0 : t.locale) ?? r.locale ?? Ye,
    i =
      (t == null ? void 0 : t.firstWeekContainsDate) ??
      ((g = (h = t == null ? void 0 : t.locale) == null ? void 0 : h.options) == null
        ? void 0
        : g.firstWeekContainsDate) ??
      r.firstWeekContainsDate ??
      ((O = (M = r.locale) == null ? void 0 : M.options) == null ? void 0 : O.firstWeekContainsDate) ??
      1,
    u =
      (t == null ? void 0 : t.weekStartsOn) ??
      ((F = (T = t == null ? void 0 : t.locale) == null ? void 0 : T.options) == null ? void 0 : F.weekStartsOn) ??
      r.weekStartsOn ??
      ((C = (E = r.locale) == null ? void 0 : E.options) == null ? void 0 : C.weekStartsOn) ??
      0,
    c = l(n, t == null ? void 0 : t.in)
  if (!$(c)) throw new RangeError('Invalid time value')
  let o = e
    .match(Ae)
    .map((m) => {
      const f = m[0]
    ...
    .map((m) => {
      ...
      const f = m[0]
      if (f === "'") return { isToken: !1, value: Je(m) }
      if (Q[f]) return { isToken: !0, value: m }
      if (f.match(Ve)) throw new RangeError('Format string contains an unescaped latin alphabet character `' + f + '`')
      return { isToken: !1, value: m }
    })
  a.localize.preprocessor && (o = a.localize.preprocessor(c, o))
  const d = { firstWeekContainsDate: i, weekStartsOn: u, locale: a }
  return o
    .map((m) => {
      if (!m.isToken) return m.value
      const f = m.value
      ;((!(t != null && t.useAdditionalWeekYearTokens) && Le(f)) ||
        (!(t != null && t.useAdditionalDayOfYearTokens) && _e(f))) &&
        je(f, e, String(n))
      const S = Q[f[0]]
...
function Je(n) {
  const e = n.match(Re)
  return e ? e[1].replace(Ie, "'") : n
}
export { $e as f }
//# sourceMappingURL=format-Cn4G_mmc.js.map
