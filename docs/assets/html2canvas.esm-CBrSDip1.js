    ...
    for (; t; )
      try {
        if (
          ((r = 1),
          B &&
            (n = o[0] & 2 ? B.return : o[0] ? B.throw || ((n = B.return) && n.call(B), 0) : B.next) &&
            !(n = n.call(B, o[1])).done)
        )
          return n
  ...
  S = function () {
    ...
    for (var r = [], B = -1, n = ''; ++B < t; ) {
      ...
      s <= 65535 ? r.push(s) : ((s -= 65536), r.push((s >> 10) + 55296, (s % 1024) + 56320)),
        (B + 1 === t || r.length > 16384) && ((n += String.fromCharCode.apply(String, r)), (r.length = 0))
    }
    return n
  },
    ...
    return (
      e.forEach(function (n, s) {
        ...
        if (
          ...
          ['normal', 'auto', 'loose'].indexOf(A) !== -1 && [8208, 8211, 12316, 12448].indexOf(n) !== -1)
        )
  ...
  fB = (function () {
    ...
    return (
      ...
      (e.prototype.consumeToken = function () {
        ...
        switch (A) {
          ...
          case ds:
            ...
            return (
              c === DA && (MA(C) || C === ve) && (this.consumeCodePoint(), this.consumeUnicodeRangeToken()),
      ...
      (e.prototype.consumeUnicodeRangeToken = function () {
        ...
        for (var r = !1; t === ve && A.length < 6; ) A.push(t), (t = this.consumeCodePoint()), (r = !0)
        if (r) {
          var B = parseInt(
              S.apply(
                void 0,
          ...
          if (B === ne) {
            ...
            n !== nA &&
              ...
              (n === Xe
                ...
                : UA(B, n) && ((t += this.consumeStringSlice(r)), (t += S(this.consumeEscapedCodePoint())), (r = -1)))
          }
          r++
        } while (!0)
      }),
...
var pt = function (e, A) {
  ...
  $s = { name: 'background-color', initialValue: 'transparent', prefix: !1, type: 3, format: 'color' },
  er = function (e, A) {
    ...
    switch (e.size) {
      case 0:
        e.shape === 0
          ...
          : e.shape === 1 &&
            ((n = Math.min(Math.abs(A), Math.abs(A - r))), (s = Math.min(Math.abs(t), Math.abs(t - B))))
        break
      case 2:
      ...
      case 1:
        e.shape === 0
          ...
          : e.shape === 1 &&
            ((n = Math.max(Math.abs(A), Math.abs(A - r))), (s = Math.max(Math.abs(t), Math.abs(t - B))))
        break
      case 3:
...
var oi = {
  ...
  wi = { name: 'text-decoration-color', initialValue: 'transparent', prefix: !1, type: 3, format: 'color' },
  ci = {
  ...
  pi = {
    ...
    parse: function (e, A) {
      return A.length === 1 && Xr(A[0], 'none')
        ...
        : sA(A).map(function (t) {
            for (
              var r = { color: 255, offsetX: X, offsetY: X, blur: X, spread: X, inset: !1 }, B = 0, n = 0;
              n < t.length;
              n++
            ) {
              var s = t[n]
              Xr(s, 'inset')
                ? (r.inset = !0)
                : pA(s)
                  ? (B === 0 ? (r.offsetX = s) : B === 1 ? (r.offsetY = s) : B === 2 ? (r.blur = s) : (r.spread = s),
                    B++)
                  : (r.color = EA.parse(e, s))
            }
            return r
  ...
  vi = { name: '-webkit-text-stroke-color', initialValue: 'currentcolor', prefix: !1, type: 3, format: 'color' },
  yi = {
  ...
  Ki = (function () {
    function e(A, t) {
      ...
      ;(this.overflowX = n[0]),
        ...
        (this.textDecorationColor = U(A, wi, (r = t.textDecorationColor) !== null && r !== void 0 ? r : t.color)),
...
var qi = 1,
  ...
  Ve = function (e, A, t, r) {
    for (var B = A.firstChild, n = void 0; B; B = n)
      if (((n = B.nextSibling), YB(B) && B.data.trim().length > 0)) t.textNodes.push(new fo(e, B, t.styles))
      else if (_A(B))
  ...
  $t = (function () {
    ...
    return (
      ...
      (e.prototype.createElementClone = function (A) {
        ...
        return (
          Wr(t) &&
            (Wr(A) && A.currentSrc && A.currentSrc !== A.src && ((t.src = A.currentSrc), (t.srcset = '')),
  ...
  qo = (function () {
    ...
    return (
      (e.prototype.addImage = function (A) {
        ...
        return this.has(A) || ((yr(A) || AQ(A)) && (this._cache[A] = this.loadImage(A)).catch(function () {})), t
      }),
            ...
            switch (i.label) {
              case 0:
                return (
                  ...
                  (B = !vr(A) && !t && !yr(A) && typeof this._options.proxy == 'string' && N.SUPPORT_CORS_XHR && !r),
    ...
    function e(A) {
      ...
      ;(this.topLeftBorderDoubleOuterBox =
        ...
        (this.topLeftBorderDoubleInnerBox =
          n > 0 || s > 0
            ? x(r.left + (E * 2) / 3, r.top + (l * 2) / 3, n - (E * 2) / 3, s - (l * 2) / 3, m.TOP_LEFT)
        ...
        (this.topLeftBorderBox = n > 0 || s > 0 ? x(r.left, r.top, n, s, m.TOP_LEFT) : new u(r.left, r.top)),
        (this.topRightBorderBox =
          a > 0 || o > 0 ? x(r.left + F, r.top, a, o, m.TOP_RIGHT) : new u(r.left + r.width, r.top)),
        (this.bottomRightBorderBox =
          g > 0 || w > 0 ? x(r.left + p, r.top + K, g, w, m.BOTTOM_RIGHT) : new u(r.left + r.width, r.top + r.height)),
        (this.bottomLeftBorderBox =
          c > 0 || C > 0 ? x(r.left, r.top + d, c, C, m.BOTTOM_LEFT) : new u(r.left, r.top + r.height)),
        ...
        (this.bottomLeftPaddingBox =
          c > 0 || C > 0
            ? x(r.left + E, r.top + Math.min(d, r.height - y), Math.max(0, c - E), Math.max(0, C - y), m.BOTTOM_LEFT)
            : new u(r.left + E, r.top + r.height - y)),
        (this.topLeftContentBox =
          n > 0 || s > 0
            ? x(r.left + E + L, r.top + l + O, Math.max(0, n - (E + L)), Math.max(0, s - (l + O)), m.TOP_LEFT)
  ...
  tn = (function () {
    function e(A, t) {
      if (
        ...
        this.container.styles.opacity < 1 && this.effects.push(new sQ(this.container.styles.opacity)),
    ...
    return (
      (e.prototype.getEffects = function (A) {
        for (
          var t = [2, 3].indexOf(this.container.styles.position) === -1, r = this.parent, B = this.effects.slice(0);
          r;
      ...
      (A.prototype.renderReplacedElement = function (t, r, B) {
        if (B && t.intrinsicWidth > 0 && t.intrinsicHeight > 0) {
          ...
          this.path(s),
            this.ctx.save(),
            this.ctx.clip(),
            this.ctx.drawImage(B, 0, 0, t.intrinsicWidth, t.intrinsicHeight, n.left, n.top, n.width, n.height),
            this.ctx.restore()
        }
      }),
                  ...
                  (r instanceof tt &&
                    ...
                    r.type === Pe
                      ...
                      : r.type === ke &&
                        ...
                        (this.ctx.save(),
                        this.ctx.beginPath(),
                        this.ctx.arc(r.bounds.left + g / 2, r.bounds.top + g / 2, g / 4, 0, Math.PI * 2, !0),
                        (this.ctx.fillStyle = R(Jt)),
                        this.ctx.fill(),
                        this.ctx.restore())),
                  EQ(r) && r.value.length)
      ...
      (A.prototype.formatPath = function (t) {
        ...
        t.forEach(function (B, n) {
          ...
          n === 0 ? r.ctx.moveTo(s.x, s.y) : r.ctx.lineTo(s.x, s.y),
            $(B) &&
              r.ctx.bezierCurveTo(B.startControl.x, B.startControl.y, B.endControl.x, B.endControl.y, B.end.x, B.end.y)
        })
      }),
                        ...
                        case 5:
                          sa(Q)
                            ? ((c = Kr(t, r, [null, null, null])),
                              ...
                              (l.fillStyle = v),
                              l.fillRect(0, 0, L, V),
                              L > 0 && V > 0 && ((y = n.ctx.createPattern(d, 'repeat')), n.renderRepeat(O, y, Y, W)))
                            : aa(Q) &&
                              ...
                              BA > 0 &&
                                uA > 0 &&
                                ((vA = n.ctx.createRadialGradient(k + Y, q + W, 0, k + Y, q + W, BA)),
                ...
                return (
                  ...
                  B || r.boxShadow.length
                    ? (this.ctx.save(),
                      this.path(s),
                      this.ctx.clip(),
                      HA(r.backgroundColor) || ((this.ctx.fillStyle = R(r.backgroundColor)), this.ctx.fill()),
                ...
                w.sent(),
                  ...
                  r.boxShadow
                    ...
                    .forEach(function (f) {
                      ...
                      f.inset ? (g.path(c), g.ctx.clip(), g.mask(H)) : (g.mask(c), g.ctx.clip(), g.path(H)),
        ...
        return P(this, void 0, void 0, function () {
          ...
          return _(this, function (v) {
            return (
              ...
              s === 3 ? ((this.ctx.lineCap = 'round'), (this.ctx.lineWidth = r)) : (this.ctx.lineWidth = r * 2 + 1.1),
        ...
        switch (oA.label) {
          case 0:
            ...
            return (
              ...
              (n = Lr({ logging: (k = A.logging) !== null && k !== void 0 ? k : !0, cache: A.cache }, B)),
              (s = {
              ...
              w ? [4, g.toIFrame(t, i)] : [2, Promise.reject('Unable to find element in cloned iframe')]
            )
          case 1:
            return (
              (f = oA.sent()),
              ...
              (p = {
                ...
                backgroundColor: K,
                scale:
                  (BA = (IA = A.scale) !== null && IA !== void 0 ? IA : r.devicePixelRatio) !== null && BA !== void 0
                    ? BA
                    : 1,
          ...
          case 5:
            return (
              (!((KA = A.removeContainer) !== null && KA !== void 0) || KA) &&
                ($t.destroy(f) || a.logger.error('Cannot detach cloned iframe as it is not in the DOM anymore')),
...
//# sourceMappingURL=html2canvas.esm-CBrSDip1.js.map
