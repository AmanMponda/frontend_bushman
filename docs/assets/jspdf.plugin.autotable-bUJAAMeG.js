function q(e, t, r, i, n) {
  ...
  var a = 1.15,
    ...
    u = 1
  if (
    ((i.valign === 'middle' || i.valign === 'bottom' || i.halign === 'center' || i.halign === 'right') &&
      ((g = typeof e == 'string' ? e.split(l) : e), (u = g.length || 1)),
    (r += h * (2 - a)),
    i.valign === 'middle' ? (r -= (u / 2) * o) : i.valign === 'bottom' && (r -= u * o),
    i.halign === 'center' || i.halign === 'right')
  ) {
    var v = h
    if ((i.halign === 'center' && (v *= 0.5), g && u >= 1)) {
      for (var d = 0; d < g.length; d++) n.text(g[d], t - n.getStringUnitWidth(g[d]) * v, r), (r += o)
      return n
    }
    t -= n.getStringUnitWidth(e) * v
  }
  return (
    i.halign === 'justify' ? n.text(e, t, r, { maxWidth: i.maxWidth || 100, align: 'justify' }) : n.text(e, t, r), n
  )
}
var M = {},
  P = (function () {
    ...
    return (
      ...
      (e.prototype.applyStyles = function (t, r) {
        var i, n, a
        r === void 0 && (r = !1),
          t.fontStyle && this.jsPDFDocument.setFontStyle && this.jsPDFDocument.setFontStyle(t.fontStyle)
        ...
        if ((this.jsPDFDocument.setFont(f, h), t.fontSize && this.jsPDFDocument.setFontSize(t.fontSize), !r)) {
          ...
          l && (i = this.jsPDFDocument).setFillColor.apply(i, l),
            ...
            typeof t.lineWidth == 'number' && this.jsPDFDocument.setLineWidth(t.lineWidth)
        }
      }),
...
function F(e, t) {
  ...
  if (((e = e || t), Array.isArray(e))) {
    if (e.length >= 4) return { top: e[0], right: e[1], bottom: e[2], left: e[3] }
    if (e.length === 3) return { top: e[0], right: e[1], bottom: e[2], left: e[1] }
    if (e.length === 2) return { top: e[0], right: e[1], bottom: e[0], left: e[1] }
    e.length === 1 ? (e = e[0]) : (e = t)
  }
  return typeof e == 'object'
    ? (typeof e.vertical == 'number' && ((e.top = e.vertical), (e.bottom = e.vertical)),
      typeof e.horizontal == 'number' && ((e.right = e.horizontal), (e.left = e.horizontal)),
      {
...
function st(e) {
  var t = ''
  return (
    (e.fontWeight === 'bold' || e.fontWeight === 'bolder' || parseInt(e.fontWeight) >= 700) && (t = 'bold'),
...
function X(e, t) {
  var r = t(e)
  return r === 'rgba(0, 0, 0, 0)' || r === 'transparent' || r === 'initial' || r === 'inherit'
...
function Z(e, t, r, i, n) {
  ...
  var f = Object.keys(e.getFontList()),
    ...
    g = [],
    u = []
  if (!h) return console.error('Html table could not be found with input: ', t), { head: l, body: g, foot: u }
  for (var v = 0; v < h.rows.length; v++) {
    var d = h.rows[v],
      m =
        (s = (a = d == null ? void 0 : d.parentElement) === null || a === void 0 ? void 0 : a.tagName) === null ||
        s === void 0
          ? void 0
          : s.toLowerCase(),
      p = ft(f, o, r, d, i, n)
...
function ft(e, t, r, i, n, a) {
  for (var s = new J(i), h = 0; h < i.cells.length; h++) {
    ...
    if (n || o.display !== 'none') {
      var l = void 0
      a && (l = ot(e, f, t, o, r)),
        s.push({ rowSpan: f.rowSpan, colSpan: f.colSpan, styles: l, _element: f, content: lt(f) })
    }
  }
...
function gt(e, t, r) {
  for (var i = 0, n = [e, t, r]; i < n.length; i++) {
    var a = n[i]
    a && typeof a != 'object' && console.error('The options parameter should be of type object, is: ' + typeof a),
      a.startY &&
        typeof a.startY != 'number' &&
        (console.error('Invalid value for startY option', a.startY), delete a.startY)
  }
}
function w(e, t, r, i, n) {
  ...
  for (var a = Object(e), s = 1; s < arguments.length; s++) {
    var h = arguments[s]
    if (h != null) for (var f in h) Object.prototype.hasOwnProperty.call(h, f) && (a[f] = h[f])
  }
  return a
}
function B(e, t) {
...
function ut(e, t, r) {
  for (
    var i = { styles: {}, headStyles: {}, bodyStyles: {}, footStyles: {}, alternateRowStyles: {}, columnStyles: {} },
      n = function (f) {
        if (f === 'columnStyles') {
          var o = e[f],
            l = t[f],
...
function vt(e, t, r) {
  for (
    var i = [e, t, r],
      n = { didParseCell: [], willDrawCell: [], didDrawCell: [], willDrawPage: [], didDrawPage: [] },
      a = 0,
      s = i;
    a < s.length;
    a++
...
function pt(e, t) {
  ...
  return typeof t == 'number'
    ? t
    : (t == null || t === !1) && a && (r == null ? void 0 : r.finalY) != null
      ? r.finalY + 20 / i
      : null
}
function yt(e, t, r) {
    ...
    Object.keys(i)
      ...
      .forEach(function (a) {
        ...
        Array.isArray(i) ? (h = i[parseInt(a)]) : (h = i[a]),
          typeof h == 'object' && !Array.isArray(h) && (s = (h == null ? void 0 : h.colSpan) || 1)
        for (var f = 0; f < s; f++) {
          var o = void 0
      ...
      (e.prototype.callCellHooks = function (t, r, i, n, a, s) {
        for (var h = 0, f = r; h < f.length; h++) {
          var o = f[h],
            ...
            g = o(l) === !1
          if (((i.text = Array.isArray(i.text) ? i.text : [i.text]), g)) return !1
        }
        return !0
      }),
  ...
  V = (function () {
    function e(t, r, i, n, a) {
      a === void 0 && (a = !1),
        (this.height = 0),
        (this.raw = t),
        t instanceof J && ((this.raw = t._element), (this.element = t._element)),
        (this.index = r),
        (this.section = i),
        (this.cells = n),
  ...
  tt = (function () {
    ...
    return (
      (e.prototype.getTextPos = function () {
        ...
        else if (this.styles.valign === 'bottom') t = this.y + this.height - this.padding('bottom')
        else {
          var r = this.height - this.padding('vertical')
          t = this.y + r / 2 + this.padding('top')
        }
        var i
        if (this.styles.halign === 'right') i = this.x + this.width - this.padding('right')
...
function xt(e, t) {
  ...
  n &&
    ...
    !t.settings.horizontalPageBreak &&
      ...
      console.warn('Of the table content, '.concat(n, ' units width could not fit page'))),
    Ht(t),
    Dt(t, e),
    Pt(t)
}
      ...
      if (o) {
        ...
        if (((o.minReadableWidth = u + o.padding('horizontal')), typeof o.styles.cellWidth == 'number'))
          ...
          o.contentWidth > n
            ...
            : ((o.minWidth = o.contentWidth), (o.wrappedWidth = o.contentWidth))
        else {
          var v = 10 / r
      ...
      for (var s = 0, h = t.columns; s < h.length; s++) {
        ...
        if (o && o.colSpan === 1)
          (f.wrappedWidth = Math.max(f.wrappedWidth, o.wrappedWidth)),
            ...
            (f.minReadableWidth = Math.max(f.minReadableWidth, o.minReadableWidth))
        else {
          var l = t.styles.columnStyles[f.dataKey] || t.styles.columnStyles[f.index] || {},
...
function Ht(e) {
  for (var t = e.allRows(), r = 0; r < t.length; r++)
    for (var i = t[r], n = null, a = 0, s = 0, h = 0; h < e.columns.length; h++) {
      var f = e.columns[h]
      if (((s -= 1), s > 1 && e.columns[h + 1])) (a += f.width), delete i.cells[f.index]
      else if (n) {
        var o = n
  ...
  for (var r = { count: 0, height: 0 }, i = 0, n = e.allRows(); i < n.length; i++) {
    for (var a = n[i], s = 0, h = e.columns; s < h.length; s++) {
      ...
      if (o) {
        ...
        else if (o.styles.overflow === 'ellipsize') o.text = N(o.text, l, o.styles, t, '...')
        else if (o.styles.overflow === 'hidden') o.text = N(o.text, l, o.styles, t, '')
...
function Wt(e, t, r, i, n) {
  ...
  for (; t < D(e + n, r, i) && !(e.length <= 1); ) e = e.substring(0, e.length - 1)
  return e.trim() + n
}
function L(e, t) {
  var r = new P(e),
        ...
        if (s[p.index] == null || s[p.index].left === 0)
          if (v === 0) {
            ...
            var c = Tt(e, p, o, n, i, a, x),
              C = new tt(y, c, e)
            ;(g[p.dataKey] = C), (g[p.index] = C), (v = C.colSpan - 1), (s[p.index] = { left: C.rowSpan - 1, times: v })
          } else v--, u++
...
function Tt(e, t, r, i, n, a, s) {
  ...
  var o = w({}, h.table, h[e], n.styles, f),
    ...
    g = e === 'body' ? l : {},
    u = e === 'body' && r % 2 === 0 ? w({}, h.alternateRow, n.alternateRowStyles) : {},
    v = nt(a),
    d = w({}, v, o, u, g)
  return w(d, s)
}
function Rt(e, t, r) {
  ...
  for (var o = !0, l = (i = r == null ? void 0 : r.start) !== null && i !== void 0 ? i : 0; l < t.columns.length; ) {
    if (a.has(l)) {
      l++
      continue
    }
...
function E(e, t) {
  ...
  var l = new P(e)
  ;(r.pageBreak === 'always' || (r.startY != null && h > l.pageSize().height)) && (it(l), (a.y = n.top)),
  ...
  for (var a = 0, s = 0, h = r.columns; s < h.length; s++) {
    ...
    if (o) {
      ...
      ;(o.contentHeight = o.getContentHeight(u, v)),
        o.contentHeight >= t && ((o.contentHeight = t), (l.styles.minCellHeight -= t)),
...
function Mt(e, t, r) {
  ...
  if ((e.getDocument().setFillColor(e.getDocument().getFillColor()), typeof i.lineWidth == 'number')) {
    ...
    typeof i.lineWidth == 'object' &&
      (i.fillColor && e.rect(t.x, r.y, t.width, t.height, 'F'), Nt(e, t, r, i.lineWidth))
}
function Nt(e, t, r, i) {
  var n, a, s, h
  i.top &&
...
function et(e, t, r, i) {
  ...
  return (
    (a === 'everyPage' || (a === 'lastPage' && r)) && (n += t.getFootHeight(t.columns)), e.pageSize().height - i.y - n
  )
}
...
try {
  if (typeof window < 'u' && window) {
    var K = window,
      _ = K.jsPDF || ((R = K.jspdf) === null || R === void 0 ? void 0 : R.jsPDF)
    _ && Ot(_)
  }
} catch (e) {
...
//# sourceMappingURL=jspdf.plugin.autotable-bUJAAMeG.js.map
