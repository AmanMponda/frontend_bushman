...
import { u as x } from './useForm-XQT-jLAz.js'
const B = w({
  ...
  setup(_) {
    ...
    return (F, e) => {
      ...
      return (
        ...
        b(
          f,
          { ref: 'passwordForm', onSubmit: y(o, ['prevent']) },
          {
            default: a(() => [
              e[3] || (e[3] = m('h1', { class: 'font-semibold text-4xl mb-4' }, 'Forgot your password?', -1)),
              e[4] ||
                (e[4] = m(
                  'p',
              ...
              r(
                ...
                { default: a(() => e[1] || (e[1] = [u('Send password')])), _: 1 },
              ),
              r(
                l,
                { to: { name: 'login' }, class: 'w-full', preset: 'secondary', onClick: o },
                { default: a(() => e[2] || (e[2] = [u('Go back')])), _: 1 },
              ),
            ]),
            _: 1,
          },
...
export { B as default }
//# sourceMappingURL=RecoverPassword-Bbhu1aED.js.map
