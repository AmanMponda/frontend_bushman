import { _ as za } from './jspdf.es.min-B9h-8Axk.js'
import './index-P4QeRV7n.js'
var Qe =
  typeof globalThis < 'u'
    ? globalThis
    : typeof window < 'u'
...
!cr &&
  ta &&
  ((le = ta.match(/Edge\/(\d+)/)), (!le || le[1] >= 74) && ((le = ta.match(/Chrome\/(\d+)/)), le && (cr = +le[1])))
var Ti = cr,
  xn = Ti,
  Hl = D,
  Yl = _,
  ...
  Fo =
    ...
    !Hl(function () {
      ...
      return !Xl(a) || !(Object(a) instanceof Symbol) || (!Symbol.sham && xn && xn < 41)
    }),
  Wl = Fo,
  Uo = Wl && !Symbol.sham && typeof Symbol.iterator == 'symbol',
  ql = Fe,
  Ql = B,
  Kl = Tr,
  Zl = Uo,
...
var Si = zo.exports,
  ...
  Ke = xh.Symbol,
  na = Th('wks'),
  $h = Eh ? Ke.for || Ke : (Ke && Ke.withoutSetter) || Oh,
  z = function (a) {
  ...
  Xo =
    ...
    !kh(function () {
      return (
        Object.defineProperty(Bh('div'), 'a', {
          get: function () {
            return 7
          },
        }).a !== 7
...
Oe.f = Jh
  ? tv
    ? function (e, t, r) {
        if (
          (Ut(e), (t = Rn(t)), Ut(r), typeof e == 'function' && t === 'prototype' && 'value' in r && la in r && !r[la])
        ) {
          var i = av(e, t)
          i &&
            i[la] &&
            ((e[t] = r.value),
            (r = { configurable: ua in r ? r[ua] : i[ua], enumerable: oa in r ? r[oa] : i[oa], writable: !1 }))
        }
        return sa(e, t, r)
      }
    : sa
  : function (e, t, r) {
      if ((Ut(e), (t = Rn(t)), Ut(r), ev))
        try {
          return sa(e, t, r)
        } catch {}
...
var iv = he,
  ...
  uv = Xa && Object.getOwnPropertyDescriptor,
  Ko = ov(Qo, 'name'),
  lv = Ko && function () {}.name === 'something',
  hv = Ko && (!Xa || (Xa && uv(Qo, 'name').configurable)),
  $r = { PROPER: lv, CONFIGURABLE: hv },
  vv = L,
  fv = B,
  Wa = Si,
  cv = vv(Function.toString)
fv(Wa.inspectSource) ||
  (Wa.inspectSource = function (a) {
    return cv(a)
  })
var $i = Wa.inspectSource,
  ...
  dv = B,
  Nn = gv.WeakMap,
  pv = dv(Nn) && /native code/.test(String(Nn)),
  yv = Ei,
  mv = Ho,
  In = yv('keys'),
  wi = function (a) {
  ...
  wv = function (a) {
    return function (e) {
      var t
      if (!xv(e) || (t = Tt(e)).type !== a) throw new qa('Incompatible receiver, ' + a + ' required')
      return t
    }
  }
if (bv || va.state) {
...
var wr = { set: gr, get: Tt, has: dr, enforce: $v, getterFor: wv },
  Ai = L,
  Cv = D,
  Av = B,
  Gt = fe,
  ...
  kv = (qo.exports = function (a, e, t) {
    Mv(_n(e), 0, 7) === 'Symbol(' && (e = '[' + _v(_n(e), /^Symbol\(([^)]*)\).*$/, '$1') + ']'),
      t && t.getter && (e = 'get ' + e),
      t && t.setter && (e = 'set ' + e),
      (!Gt(a, 'name') || (Pv && a.name !== e)) && (Qa ? or(a, 'name', { value: e, configurable: !0 }) : (a.name = e)),
      Dv && t && Gt(t, 'arity') && a.length !== t.arity && or(a, 'length', { value: t.arity })
    try {
      t && Gt(t, 'constructor') && t.constructor
        ? Qa && or(a, 'prototype', { writable: !1 })
...
var eu = qo.exports,
  ...
  Ue = function (a, e, t, r) {
    ...
    if ((Bv(t) && Fv(t, n, r), r.global)) i ? (a[e] = t) : Uv(e, t)
    else {
      try {
      ...
      i
        ? (a[e] = t)
        : jv.f(a, e, { value: t, enumerable: !1, configurable: !r.nonConfigurable, writable: !r.nonWritable })
    }
    return a
  },
  tu = {},
...
var ff = Fe,
  ...
  ee = function (a, e) {
    var t = a.target,
      ...
      l,
      h
    if ((r ? (o = zt) : i ? (o = zt[t] || Mf(t, {})) : (o = zt[t] && zt[t].prototype), o))
      for (s in e) {
        if (
          ((l = e[s]),
          a.dontCallGetSet ? ((h = Rf(o, s)), (u = h && h.value)) : (u = o[s]),
          (n = Vf(r ? s : t + (i ? '.' : '#') + s, a.forced)),
          !n && u !== void 0)
        ) {
  ...
  su = (function () {
    return Ht('Bun/')
      ? 'BUN'
      : Ht('Cloudflare-Workers')
        ? 'CLOUDFLARE'
        : Ht('Deno/')
          ? 'DENO'
          : Ht('Node.js/')
            ? 'NODE'
            : vt.Bun && typeof Bun.version == 'string'
              ? 'BUN'
              : vt.Deno && typeof Deno.version == 'object'
                ? 'DENO'
                : Lf(vt.process) === 'process'
                  ? 'NODE'
                  : vt.window && vt.document
                    ? 'BROWSER'
                    : 'REST'
  })(),
  kf = su,
...
var Rc =
  ...
  Hc = Fe,
  pu = Hc('document', 'documentElement'),
  Yc = L,
  Xc = Yc([].slice),
  Wc = TypeError,
  qc = function (a, e) {
  ...
  Qc = wt,
  yu = /(?:ipad|iphone|ipod).*applewebkit/i.test(Qc),
  ie = _,
  Kc = du,
  Zc = Mi,
  zn = B,
  ...
  ag = Ar,
  Ka = ie.setImmediate,
  Xn = ie.clearImmediate,
  ig = ie.process,
  ca = ie.Dispatch,
  ng = ie.Function,
  Wn = ie.MessageChannel,
  sg = ie.String,
  ga = 0,
  bt = {},
...
;(!Ka || !Xn) &&
  ...
  ag
    ...
    : ca && ca.now
      ...
      : Wn && !rg
        ? ((da = new Wn()), (pa = da.port2), (da.port1.onmessage = Qn), (Ie = Zc(pa.postMessage, pa)))
        : ie.addEventListener && zn(ie.postMessage) && !ie.importScripts && Ot && Ot.protocol !== 'file:' && !mu(Kn)
          ? ((Ie = Kn), ie.addEventListener('message', Qn, !1))
          : qn in Yn('script')
            ? (Ie = function (a) {
...
var Tu = xu,
  hg = wt,
  vg = /ipad|iphone|ipod/i.test(hg) && typeof Pebble < 'u',
  fg = wt,
  cg = /web0s(?!.*chrome)/i.test(fg),
  at = _,
  gg = lg,
  Jn = Mi,
  ma = bu.set,
  ...
  mg = cg,
  ba = Ar,
  es = at.MutationObserver || at.WebKitMutationObserver,
  ts = at.document,
  rs = at.process,
  Yt = at.Promise,
  Za = gg('queueMicrotask'),
  Xe,
  xa,
  Ta,
  Xt,
...
if (!Za) {
  var Wt = new dg(),
    qt = function () {
      var a, e
      for (ba && (a = rs.domain) && a.exit(); (e = Wt.get()); )
        try {
          e()
        } catch (t) {
          throw (Wt.head && Xe(), t)
  ...
  !pg && !ba && !mg && es && ts
    ? ((xa = !0),
      ...
      new es(qt).observe(Ta, { characterData: !0 }),
      (Xe = function () {
        Ta.data = xa = !xa
      }))
    : !yg && Yt && Yt.resolve
      ? ((Xt = Yt.resolve(void 0)),
        (Xt.constructor = Yt),
        (as = Jn(Xt.then, Xt)),
        (Xe = function () {
          as(qt)
...
var Cg = wg('species'),
  Ja = !1,
  Ou = Sg(Og.PromiseRejectionEvent),
  Ag = Eg('Promise', function () {
    var a = $g(xt),
      e = a !== String(xt)
    if (!e && Oa === 66) return !0
    if (!Oa || Oa < 51 || !/native code/.test(a)) {
      var t = new xt(function (n) {
        ...
        i = (t.constructor = {})
      if (((i[Cg] = r), (Ja = t.then(function () {}) instanceof r), !Ja)) return !0
    }
    return !e && (is === 'BROWSER' || is === 'DENO') && !Ou
  }),
  Pt = { CONSTRUCTOR: Ag, REJECTION_EVENT: Ou, SUBCLASSING: Ja },
  ut = {},
  ns = Te,
  Pg = TypeError,
  Rg = function (a) {
...
var Ng = ee,
  ...
  ti = $u.f,
  Hg = ti,
  Yg = !!(ei && ei.createEvent && we.dispatchEvent),
  Au = 'unhandledrejection',
  Xg = 'rejectionhandled',
  us = 0,
  Pu = 1,
  Wg = 2,
  ...
  Mu = function (a, e) {
    ...
    try {
      i
        ? (r || (e.rejection === Ru && Qg(e), (e.rejection = Bi)),
          i === !0 ? (u = t) : (s && s.enter(), (u = i(t)), s && (s.exit(), (h = !0))),
          u === a.promise ? o(new Cu('Promise-chain cycle')) : (l = Iu(u)) ? it(l, u, n, o) : n(u))
        : o(t)
    } catch (f) {
      s && !h && s.exit(), o(f)
    }
  ...
  _u = function (a, e) {
    a.notified ||
      ((a.notified = !0),
      Di(function () {
        for (var t = a.reactions, r; (r = t.get()); ) Mu(r, a)
  ...
  Vu = function (a, e, t) {
    var r, i
    Yg
      ? ((r = ei.createEvent('Event')), (r.promise = e), (r.reason = t), r.initEvent(a, !1, !0), we.dispatchEvent(r))
      : (r = { promise: e, reason: t }),
      !Ug && (i = we['on' + a]) ? i(r) : a === Au && Bg('Unhandled promise rejection', t)
  },
  qg = function (a) {
    it(Su, we, function () {
      var e = a.facade,
...
Ng({ global: !0, constructor: !0, wrap: !0, forced: wu }, { Promise: Le })
Nu = Ig.Promise
Mg(Le, Ir, !1)
_g(Ir)
var Rt = {},
  ...
  Lu = function (a, e, t) {
    ...
    if (n) l = a.iterator
      ...
      if (Td(h)) {
        for (f = 0, c = Od(a); c > f; f++) if (((v = y(a[f])), v && gs(ps, v))) return v
        return new hr(!1)
      }
      l = Sd(a, h)
    }
...
var Bd = ee,
  ...
  ms = ai && ai.prototype
Bd(
  { target: 'Promise', proto: !0, forced: jd, real: !0 },
  {
    catch: function (a) {
...
var fp =
  ...
  Uu = { BROKEN_CARET: fp, UNSUPPORTED_Y: Ui },
  Gu = {},
  cp = au,
  gp = Ri,
  dp =
...
var Gi =
    ...
    function (e, t) {
      var r
      return (
        e !== null ? ((Ea[ii] = Op(e)), (r = new Ea()), (Ea[ii] = null), (r[zu] = e)) : (r = vr()),
        t === void 0 ? r : Sp.f(r, t)
      )
    },
  Pp = D,
...
`) &&
  ...
  Gp = Ip,
  zp = Dp,
  Hp = jp('native-string-replace', String.prototype.replace),
...
`)) &&
          ((p = '(?: ' + p + ')'), (x = ' ' + x), y++),
        (s = new RegExp('^(?:' + p + ')', d))),
      ui && (s = new RegExp('^' + p + '$(?!\\s)', d)),
      oi && (u = t.lastIndex),
      (l = Je(mr, g ? s : t, x)),
      g
        ? l
          ? ((l.input = $a(l.input, y)), (l[0] = $a(l[0], y)), (l.index = t.lastIndex), (t.lastIndex += l[0].length))
          : (t.lastIndex = 0)
        : oi && l && (t.lastIndex = t.global ? l.index + l[0].length : u),
      ui &&
        l &&
        l.length > 1 &&
        Je(Hp, l[0], s, function () {
          for (h = 1; h < arguments.length - 2; h++) arguments[h] === void 0 && (l[h] = void 0)
        }),
      l && v)
    )
      for (l.groups = f = Fp(null), h = 0; h < v.length; h++) (c = v[h]), (f[c[0]] = l[c[1]])
    return l
  })
var zi = si,
  Qp = ee,
  $s = zi
Qp({ target: 'RegExp', proto: !0, forced: /./.exec !== $s }, { exec: $s })
var ws = Y,
  Cs = Ue,
  Kp = zi,
  As = D,
    ...
    if (!n || !o || t) {
      var s = /./[i],
        u = e(i, ''[a], function (l, h, f, c, v) {
          var g = h.exec
          return g === Kp || g === wa.exec
            ? n && !v
              ? { done: !0, value: ws(s, h, f, c) }
              : { done: !0, value: ws(l, f, h, c) }
            : { done: !1 }
        })
    ...
    return function (e, t) {
      ...
      return i < 0 || i >= n
        ? a
          ...
          : void 0
        : ((o = Ps(r, i)),
          o < 55296 || o > 56319 || i + 1 === n || (s = Ps(r, i + 1)) < 56320 || s > 57343
            ? a
              ? ay(r, i)
              : o
            : a
...
var Qi = L,
  ...
  Vy = /\$([$&'`]|\d{1,2}|<[^>]*>)/g,
  Dy = /\$([$&'`]|\d{1,2})/g,
  Ly = function (a, e, t, r, i, n) {
    var o = t + a.length,
      s = r.length,
      u = Dy
    return (
      i !== void 0 && ((i = Iy(i)), (u = Vy)),
      _y(n, u, function (l, h) {
        var f
        switch (Ca(h, 0)) {
          case '$':
    ...
    return [
      ...
      function (i, n) {
        ...
        for (var p = '', y = 0, x = 0; x < v.length; x++) {
          g = v[x]
          for (var b = Me(g[0]), T = Jy(em(zy(g.index), s.length), 0), $ = [], E, O = 1; O < g.length; O++)
            Pa($, rm(g[O]))
          var C = g.groups
          if (l) {
            var P = tm([b], $, T, s)
...
var nm = ae,
  ...
  vm = TypeError,
  Ki = function (a) {
    if (hm(a)) throw new vm("The method doesn't accept regular expressions")
    return a
  },
  fm = z,
  cm = fm('match'),
...
gm(
  { target: 'String', proto: !0, forced: !Sm && !Wu },
  {
    startsWith: function (e) {
      var t = ks(bm(this))
      mm(e)
      var r = ym(Om(arguments.length > 1 ? arguments[1] : void 0, t.length)),
        i = ks(e)
...
var Em = z,
  ...
  hi = Em('unscopables'),
  vi = Array.prototype
vi[hi] === void 0 && wm(vi, hi, { configurable: !0, value: $m(null) })
var Cm = function (a) {
    vi[hi][a] = !0
  },
  Am = D,
...
var Ku = { IteratorPrototype: ke, BUGGY_SAFARI_ITERATORS: Qu },
  Um = Ku.IteratorPrototype,
  Gm = Gi,
  zm = xi,
  Hm = Pr,
  Ym = Rt,
  ...
  a0 = Zu.PROPER,
  i0 = Zu.CONFIGURABLE,
  Gs = Ju.IteratorPrototype,
  tr = Ju.BUGGY_SAFARI_ITERATORS,
  ct = t0('iterator'),
  zs = 'keys',
  gt = 'values',
  Hs = 'entries',
  ...
  s0 = function (a, e, t, r, i, n, o) {
    ...
    if (
      (v &&
        ...
        g !== Object.prototype &&
          g.next &&
          (Fs(g) !== Gs && (Us ? Us(g, Gs) : Km(g[ct]) || Ia(g, ct, n0)), Jm(g, u, !0))),
      a0 &&
        i === gt &&
        f &&
        f.name !== gt &&
      ...
      if (((d = { values: s(gt), keys: n ? c : s(zs), entries: s(Hs) }), o))
        for (p in d) (tr || l || !(p in h)) && Ia(h, p, d[p])
  ...
  g0 = h0(
    ...
    'Array',
    function (a, e) {
      f0(this, { type: tl, target: u0(a), index: 0, kind: e })
    },
    function () {
      var a = c0(this),
        e = a.target,
...
var d0 = {
  ...
  p0 = Er,
  Ma = p0('span').classList,
  Ws = Ma && Ma.constructor && Ma.constructor.prototype,
  y0 = Ws === Object.prototype ? void 0 : Ws,
  qs = _,
  rl = d0,
  m0 = y0,
  pt = g0,
...
var S0 = Te,
  ...
  w0 = Pi,
  Ks = TypeError,
  Zs = 'Reduce of empty array with no initial value',
  C0 = function (a) {
    return function (e, t, r, i) {
      ...
      if (r < 2)
        for (;;) {
          ...
          if (((u += l), a ? u < 0 : s <= u)) throw new Ks(Zs)
        }
  ...
  V0 = _0 || !I0('reduce')
R0(
  { target: 'Array', proto: !0, forced: V0 },
  {
    reduce: function (e) {
...
D0(
  { target: 'String', proto: !0, forced: !H0 && !nl },
  {
    endsWith: function (e) {
      var t = eo(F0(this))
      j0(e)
...
if (!nt || !St) {
  ...
  ;(nt = function (a) {
    ...
    return _e.push({ handle: ++io, callback: a, cancelled: !1 }), io
  }),
    (St = function (a) {
...
\v\f\r                　\u2028\u2029\uFEFF`,
  ...
  Tb = mb
bb(
  { target: 'String', proto: !0, forced: Tb('trim') },
  {
    trim: function () {
      return xb(this)
    },
...
var Ob = function (a) {
  ...
  ;(this.r = this.r < 0 || isNaN(this.r) ? 0 : this.r > 255 ? 255 : this.r),
    ...
    (this.toHex = function () {
      ...
      return (
        u.length == 1 && (u = '0' + u), l.length == 1 && (l = '0' + l), h.length == 1 && (h = '0' + h), '#' + u + l + h
      )
    }),
    (this.getHelpXML = function () {
      ...
      for (var l = 0; l < u.length; l++)
        try {
          ...
          ;(p.style.cssText = 'margin: 3px; border: 1px solid black; background:' + d.toHex() + '; color:' + d.toHex()),
...
var Sb = ee,
  ...
  Cb = ul || !wb('indexOf')
Sb(
  { target: 'Array', proto: !0, forced: Cb },
  {
    indexOf: function (e) {
...
var Ab = ee,
  ...
  Mb = Pb(''.indexOf)
Ab(
  { target: 'String', proto: !0, forced: !Ib('includes') },
  {
    includes: function (e) {
  ...
  function t() {
    ...
    return i(function (f, c, v) {
      return (
        ...
        f.type & m.CURVE_TO
          ? ((s = f.relative ? c + f.x2 : f.x2), (u = f.relative ? v + f.y2 : f.y2))
          : ((s = NaN), (u = NaN)),
        ...
        f.type & m.QUAD_TO
          ? ((l = f.relative ? c + f.x1 : f.x1), (h = f.relative ? v + f.y1 : f.y1))
          : ((l = NaN), (h = NaN)),
        f
      )
    })
  ...
  function n(s, u, l, h, f, c) {
    return (
      ...
      i(function (v, g, d, p) {
        ...
        v.type & m.HORIZ_LINE_TO && u !== 0 && ((v.type = m.LINE_TO), (v.y = v.relative ? 0 : d)),
          v.type & m.VERT_LINE_TO && l !== 0 && ((v.type = m.LINE_TO), (v.x = v.relative ? 0 : g)),
      ...
      return (
        ...
        i(function (h, f, c, v, g) {
          ...
          return (
            ...
            s &&
              h.type & m.CLOSE_PATH &&
              ((h.type = m.LINE_TO), (h.x = h.relative ? v - f : v), (h.y = h.relative ? g - c : g)),
            h.type & m.ARC &&
              (h.rX === 0 || h.rY === 0) &&
    ...
    (a.SANITIZE = function (s) {
      ...
      return i(function (c, v, g, d, p) {
        var y = Math.abs,
          ...
          T = 0
        if (
          (c.type & m.SMOOTH_CURVE_TO && ((b = isNaN(u) ? 0 : v - u), (T = isNaN(l) ? 0 : g - l)),
          c.type & (m.CURVE_TO | m.SMOOTH_CURVE_TO)
            ? ((u = c.relative ? v + c.x2 : c.x2), (l = c.relative ? g + c.y2 : c.y2))
            : ((u = NaN), (l = NaN)),
          c.type & m.SMOOTH_QUAD_TO
            ? ((h = isNaN(h) ? v : 2 * v - h), (f = isNaN(f) ? g : 2 * g - f))
            : c.type & m.QUAD_TO
              ? ((h = c.relative ? v + c.x1 : c.x1), (f = c.relative ? g + c.y1 : c.y2))
              : ((h = NaN), (f = NaN)),
          ...
          ;(b = isNaN(h) ? (c.x1 === void 0 ? b : c.relative ? c.x : c.x1 - v) : h - v),
            (T = isNaN(f) ? (c.y1 === void 0 ? T : c.relative ? c.y : c.y1 - g) : f - g)
        ...
        return m.ARC === s.type
          ? (function (h, f, c) {
              ...
              for (
                ...
                var C = vo(h.phi1, h.phi2, O / b),
                  P = vo(h.phi1, h.phi2, (O + 1) / b),
                  V = P - C,
                ...
                var K = function (se, ge) {
                  var Se = yi([se * h.rX, ge * h.rY], h.xRot),
                    ze = Se[0],
                    It = Se[1]
                ...
                ;(v = K(X, W)),
                  ...
                  (T[O].y = d[1]),
                  h.relative &&
                    ((T[O].x1 -= $), (T[O].y1 -= E), (T[O].x2 -= $), (T[O].y2 -= E), (T[O].x -= $), (T[O].y -= E)),
                  ($ = (p = [T[O].x, T[O].y])[0]),
                  (E = p[1])
              }
              return T
          ...
          if (d.type & m.ARC) {
            ...
            for (
              var E = (d.xRot / 180) * Math.PI,
                ...
                V = Math.cos(E) * d.rY,
                j =
                  d.phi1 < d.phi2 ? [d.phi1, d.phi2] : -180 > d.phi2 ? [d.phi2 + 360, d.phi1 + 360] : [d.phi2, d.phi1],
                R = j[0],
                X = j[1],
                W = function (M) {
                  var K = M[0],
              ...
              if ((s !== '-' && s !== '+') || !this.curNumberHasExp || this.curNumberHasExpDigits)
                if (s !== '.' || this.curNumberHasExp || this.curNumberHasDecimal || u) {
                  if (this.curNumber && this.curCommandType !== -1) {
                    ...
                    this.curArgs.push(h),
                      this.curArgs.length === Gb[this.curCommandType] &&
                      ...
                      if (l) (this.curNumber = s), (this.curNumberHasDecimal = !1)
                        ...
                        if (!this.canParseCommandOrComma)
                          throw new SyntaxError(
                            'Unexpected character "' + s + '" at index ' + o + '. Command cannot follow comma',
                          )
...
class b1 {
  ...
  mapXY(e, t) {
    for (var { window: r, ctx: i } = this.screen, n = new k(e, t), o = i.canvas; o; )
...
var dl = typeof window < 'u' ? window : null,
  pl = typeof fetch < 'u' ? fetch.bind(void 0) : null
class Dr {
  constructor(e) {
    ...
    if (
      ...
      var d = Date.now(),
        ...
        x = () => {
          ;(d = Date.now()),
            (y = d - p),
            y >= g && ((p = d - (y % g)), this.shouldUpdate(i, s) && (this.render(e, n, o, u, l, h, f), v.runEvents())),
  ...
  render(e, t, r, i, n, o, s) {
    ...
    !t &&
      ...
      (g.hasValue() && ((v.width = g.getPixels('x')), v.style && (v.style.width = ''.concat(v.width, 'px'))),
      d.hasValue() && ((v.height = d.getPixels('y')), v.style && (v.style.height = ''.concat(v.height, 'px'))))
    var p = v.clientWidth || v.width,
      y = v.clientHeight || v.height
    if (
      (t && g.hasValue() && d.hasValue() && ((p = g.getPixels('x')), (y = d.getPixels('y'))),
      h.setCurrent(p, y),
...
class Z {
  ...
  toString() {
    return [I1(this.fontStyle), this.fontVariant, M1(this.fontWeight), this.fontSize, N1(this.fontFamily)]
      .join(' ')
      .trim()
  }
}
...
class ce {
  ...
  sumCubic(e, t, r, i, n) {
    return (
      Math.pow(1 - e, 3) * t + 3 * Math.pow(1 - e, 2) * e * r + 3 * (1 - e) * Math.pow(e, 2) * i + Math.pow(e, 3) * n
    )
  }
  ...
  setContext(e) {
      ...
      if (
        ...
        typeof e.setLineDash < 'u'
          ...
          : typeof e.webkitLineDash < 'u'
            ? (e.webkitLineDash = T)
            : typeof e.mozDash < 'u' && !(T.length === 1 && T[0] === 0) && (e.mozDash = T)
        var $ = b.getPixels()
    ...
    if (((this.modifiedEmSizeStack = !1), typeof e.font < 'u')) {
      ...
      O.setValue(R.fontStyle),
        ...
        (e.font = R.toString()),
        V.isPixels() && ((this.document.emSize = V.getPixels()), (this.modifiedEmSizeStack = !0))
    }
...
class A extends Ge {
  ...
  static pathA(e) {
    ...
    return (
      mi(y, x) <= -1 && (b = Math.PI),
      mi(y, x) >= 1 && (b = 0),
      { currentPoint: h, rX: i, rY: n, sweepFlag: u, xAxisRotation: l, centp: d, a1: p, ad: b }
    )
  }
  pathA(e, t) {
    var { pathParser: r } = this,
...
class Ce extends Ge {
  ...
  setContext(e) {
    ...
    var r =
      this.getStyle('dominant-baseline').getTextBaseline() || this.getStyle('alignment-baseline').getTextBaseline()
    r && (e.textBaseline = r)
  }
  ...
  setContext(e) {
    ...
    v && ((d = v[0]), (p = v[1])),
      this.root ||
        ...
        this.type === 'marker' && ((y = d), (x = p), (d = 0), (p = 0))),
      i.viewPort.setCurrent(u, l),
      this.node &&
        (!this.parent ||
          ((t = this.node.parentNode) === null || t === void 0 ? void 0 : t.nodeName) === 'foreignObject') &&
...
class V1 extends A {
  ...
  path(e) {
    ...
    return (
      e && i > 0 && (e.beginPath(), e.arc(t, r, i, 0, Math.PI * 2, !1), e.closePath()),
...
class L1 extends A {
  ...
  getPoints() {
    return [
      new k(this.getAttribute('x1').getPixels('x'), this.getAttribute('y1').getPixels('y')),
      new k(this.getAttribute('x2').getPixels('x'), this.getAttribute('y2').getPixels('y')),
    ]
  }
  path(e) {
...
class Ol extends I {
  ...
  createGradient(e, t, r) {
    ...
    if (
      ...
      var c = new rn(s, null)
      ;(c.attributes.transform = new S(s, 'transform', this.getAttribute('gradientTransform').getValue())),
        (c.children = [f])
      var v = new Nt(s, null)
...
class G1 extends Ol {
  ...
  getGradient(e, t) {
    ...
    this.getAttribute('fx').hasValue() &&
      (s = r ? i.x + i.width * this.getAttribute('fx').getNumber() : this.getAttribute('fx').getPixels('x')),
      this.getAttribute('fy').hasValue() &&
        (u = r ? i.y + i.height * this.getAttribute('fy').getNumber() : this.getAttribute('fy').getPixels('y'))
...
class Z1 extends Ce {
  ...
  calcLength(e, t, r, i) {
    ...
    switch (r) {
      ...
      case w.CURVE_TO:
        for (
          n = 0, o = this.getPointOnCubicBezier(0, e, t, i[0], i[1], i[2], i[3], i[4], i[5]), u = 0.01;
          u <= 1;
          u += 0.01
        )
          (s = this.getPointOnCubicBezier(u, e, t, i[0], i[1], i[2], i[3], i[4], i[5])),
  ...
  getPathLength() {
    return (
      this.pathLength === -1 &&
        (this.pathLength = this.dataArray.reduce((e, t) => (t.pathLength > 0 ? e + t.pathLength : e), 0)),
      this.pathLength
    )
  }
    ...
    if (!this.equidistantCache || this.equidistantCache.step !== n || this.equidistantCache.precision !== i) {
      ...
      for (var o = 0, s = 0; s <= r; s += i) {
        ...
        !u ||
          ...
          o >= n && (this.equidistantCache.points.push({ x: u.x, y: u.y, distance: s }), (o -= n)))
      }
    }
  }
  ...
  apply(e, t, r, i, n) {
    for (var { includeOpacity: o, matrix: s } = this, u = e.getImageData(0, 0, i, n), l = 0; l < n; l++)
      for (var h = 0; h < i; h++) {
        ...
        o && ((d = 0), (p = 0), (y = 0), (x *= g / 255)),
          sr(u.data, h, l, i, n, 0, d),
...
class mt {
  ...
  render() {
    ...
    return xe(function* () {
      ...
      t.start(De({ enableRedraw: !0, ignoreAnimation: !0, ignoreMouse: !0 }, r)), yield t.ready(), t.stop()
    })()
  }
  start() {
    var e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {},
...
//# sourceMappingURL=index.es-BkUPJyKD.js.map
